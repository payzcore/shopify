...
interface PaymentTexts {
  ...
  chainSelector: Record<string, string>;
}
...
const DEFAULTS: PaymentTexts = {
  ...
  complete: {
    ...
    detail: '{amount} {token} received on {chain} for order {order}.',
  ...
  if (existsSync(configPath)) {
    try {
      ...
      cachedTexts = {
        ...
        chainSelector: { ...DEFAULTS.chainSelector, ...custom.chainSelector },
      };
    } catch {
