...
;(async () => {
  ...
  // Fetch chain config from PayzCore API (non-fatal)
  ...
  server = app.listen(config.app.port, () => {
    ...
    console.log(`[PayzCore Shopify] Enabled chains: ${config.app.enabledChains.join(', ')}`)
    console.log(`[PayzCore Shopify] Default chain: ${config.app.defaultChain}`)
